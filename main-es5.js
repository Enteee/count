...
var map = {
	...
	"./counter-analytics/counter-analytics.module": [
		...
		"default~counter-analytics-counter-analytics-module~counter-count-counter-count-module~counter-settin~1b177bc7",
...
var DayOfMonthHistogramComponent = /** @class */ (function () {
    function DayOfMonthHistogramComponent(counterAnalyticsService) {
        ...
        this.xaxis = {
            ...
            labels: {
                formatter: function (value, raw) { return 'Day ' + value; },
            },
            tooltip: {
                enabled: false,
            },
    ...
    DayOfMonthHistogramComponent.prototype.ngOnInit = function () {
        this.series = [
            {
                name: 'Plus',
                data: this.counterAnalyticsService.extractHistogramData(this.counter, 'getDate', function (e) { return e.delta > 0; }, 31)
            },
            {
                name: 'Minus',
                data: this.counterAnalyticsService.extractHistogramData(this.counter, 'getDate', function (e) { return e.delta < 0; }, 31)
    ...
    DayOfMonthHistogramComponent.ctorParameters = function () { return [
...
var DayOfWeekHistogramComponent = /** @class */ (function () {
    ...
    DayOfWeekHistogramComponent.prototype.ngOnInit = function () {
        var plusData = this.counterAnalyticsService.extractHistogramData(this.counter, 'getDay', function (e) { return e.delta > 0; }, 7);
        // make sunday last day
        plusData.push(plusData.shift());
        var minusData = this.counterAnalyticsService.extractHistogramData(this.counter, 'getDay', function (e) { return e.delta < 0; }, 7);
        // make sunday last day
    ...
    DayOfWeekHistogramComponent.ctorParameters = function () { return [
        { type: _services_counter_analytics_service__WEBPACK_IMPORTED_MODULE_2__["CounterAnalyticsService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
var HourOfDayRadarComponent = /** @class */ (function () {
    ...
    HourOfDayRadarComponent.prototype.ngOnInit = function () {
        this.series = [
            {
                name: 'Plus',
                data: this.counterAnalyticsService.extractHistogramData(this.counter, 'getHours', function (e) { return e.delta > 0; }, 24)
            }, {
                name: 'Minus',
                data: this.counterAnalyticsService.extractHistogramData(this.counter, 'getHours', function (e) { return e.delta < 0; }, 24)
            },
    ...
    HourOfDayRadarComponent.ctorParameters = function () { return [
        { type: _services_counter_analytics_service__WEBPACK_IMPORTED_MODULE_2__["CounterAnalyticsService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
var PlusMinusTotalsPieChartComponent = /** @class */ (function () {
    ...
    PlusMinusTotalsPieChartComponent.prototype.ngOnInit = function () {
        var data = this.counterAnalyticsService.extractTotalData(this.counter);
        this.series = [data.totals.positive, data.totals.negative];
    };
    PlusMinusTotalsPieChartComponent.ctorParameters = function () { return [
        { type: _services_counter_analytics_service__WEBPACK_IMPORTED_MODULE_2__["CounterAnalyticsService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
var YearHeatmapComponent = /** @class */ (function () {
    ...
    YearHeatmapComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.series = [
            ...
            name: v,
            data: _this.counterAnalyticsService.extractHistogramData(_this.counter, 'getDate', function (e) { return e.delta > 0 && e.timestamp.getMonth() === i; }, 31)
        }); }).reverse();
    };
    YearHeatmapComponent.ctorParameters = function () { return [
        { type: _services_counter_analytics_service__WEBPACK_IMPORTED_MODULE_2__["CounterAnalyticsService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
var AnalyticsItemRepositoryService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](AnalyticsItemRepositoryService, _super);
    function AnalyticsItemRepositoryService() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AnalyticsItemRepositoryService.prototype.loadAll = function () {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model */ "./src/app/models/model.ts");



var AnalyticsItem = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](AnalyticsItem, _super);
    function AnalyticsItem(component, info) {
        var _this = _super.call(this) || this;
        _this.component = component;
        _this.info = info;
        _this.id = _this.info.url;
        return _this;
    }
    AnalyticsItem.ctorParameters = function () { return [
...
var AppStateRepositoryService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](AppStateRepositoryService, _super);
    function AppStateRepositoryService() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AppStateRepositoryService.prototype.init = function (MCtor) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _super.prototype.init.call(this, MCtor)];
                    case 1:
                        _a.sent();
                        ...
                        return [4 /*yield*/, _super.prototype.deleteAll.call(this)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.save(this.appState)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    AppStateRepositoryService.prototype.save = function (m) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.appState = m;
                        return [4 /*yield*/, _super.prototype.save.call(this, m)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Object.defineProperty(AppStateRepositoryService.prototype, "state", {
        get: function () {
    ...
    AppStateRepositoryService.prototype.resolve = function () {
        return this.state;
    };
...
var AppState = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](AppState, _super);
    function AppState() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.disableNotImplemented = false;
        _this.updateChannel = UpdateChannel.Production;
        _this.recordPosition = true;
        _this.vibrate = true;
        return _this;
    }
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var CountEventRepositoryService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](CountEventRepositoryService, _super);
    function CountEventRepositoryService() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CountEventRepositoryService.prototype.getByCounter = function (counter) {
        return this.all.filter(function (c) { return c.counterId === counter.id; });
    };
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CountEventType", function() { return CountEventType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CountEvent", function() { return CountEvent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var cerialize__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! cerialize */ "./node_modules/cerialize/index.js");
/* harmony import */ var cerialize__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(cerialize__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model */ "./src/app/models/model.ts");
...
var CountEvent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](CountEvent, _super);
    function CountEvent(counterId, delta, position, type, timestamp) {
        if (position === void 0) { position = null; }
        if (type === void 0) { type = CountEventType.Change; }
        if (timestamp === void 0) { timestamp = new Date(); }
        var _this = _super.call(this) || this;
        _this.counterId = counterId;
        _this.delta = delta;
    ...
    CountEvent.ctorParameters = function () { return [
        { type: String },
        { type: Number },
        { type: Position },
        null,
...
var CounterRepositoryService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](CounterRepositoryService, _super);
    function CounterRepositoryService() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(CounterRepositoryService.prototype, "allSortBySortOrder", {
        get: function () {
            return this.all.sort(function (c1, c2) { return c1.sortOrder - c2.sortOrder; });
        },
        enumerable: true,
        configurable: true
    });
...
var Counter = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](Counter, _super);
    function Counter() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.title = 'new Counter';
        _this.count = 0;
        _this.plusCount = 1;
        _this.minusCount = 0;
        _this.positiveWrapAround = 1;
        _this.positiveWrapAroundActive = false;
        _this.negativeWrapAround = -1;
        _this.negativeWrapAroundActive = false;
        _this.locked = false;
        _this.sortOrder = 0;
        _this.vibrate = true;
        return _this;
 ...
 */
var ModelRepositoryService = /** @class */ (function () {
    function ModelRepositoryService(storage) {
        this.storage = storage;
        this.models = {};
    }
    ModelRepositoryService.prototype.init = function (MCtor) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    Object.defineProperty(ModelRepositoryService.prototype, "all", {
        get: function () {
    ...
    ModelRepositoryService.prototype.save = function (m) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.models[m.id] = m;
                        return [4 /*yield*/, this.storage.set(this.MCtor.name + m.id, Object(cerialize__WEBPACK_IMPORTED_MODULE_2__["Serialize"])(m, this.MCtor))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ModelRepositoryService.prototype.delete = function (m) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storage.remove(this.MCtor.name + m.id)];
                    case 1:
                        _a.sent();
    ...
    ModelRepositoryService.prototype.deleteAll = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modelsToDelete;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        modelsToDelete = [];
                        return [4 /*yield*/, this.storage.forEach(function (v, k) {
                                // only delete instance of this class
                                if (k.startsWith(_this.MCtor.name)) {
                                    modelsToDelete.push(Object(cerialize__WEBPACK_IMPORTED_MODULE_2__["Deserialize"])(v, _this.MCtor));
                                }
                            })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, Promise.all(modelsToDelete.map(function (model) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            delete this.models[model.id];
                                            return [4 /*yield*/, this.storage.remove(this.MCtor.name + model.id)];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
    ...
    ModelRepositoryService.prototype.getById = function (id) {
        return this.models[id];
    };
    ModelRepositoryService.prototype.resolve = function (route) {
        return this.getById(route.paramMap.get(this.MCtor.name.toLowerCase() + '-id'));
    };
    ModelRepositoryService.prototype.loadAll = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storage.forEach(function (v, k) {
                            // only load instance of this class
                            if (k.startsWith(_this.MCtor.name)) {
                                var model = Object(cerialize__WEBPACK_IMPORTED_MODULE_2__["Deserialize"])(v, _this.MCtor);
    ...
    ModelRepositoryService.ctorParameters = function () { return [
 ...
 * any data.
 */
var VolatileModelRepositoryService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](VolatileModelRepositoryService, _super);
    function VolatileModelRepositoryService() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    VolatileModelRepositoryService.prototype.save = function (m) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.models[m.id] = m;
                return [2 /*return*/];
    ...
    VolatileModelRepositoryService.prototype.delete = function (m) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                delete this.models[m.id];
                return [2 /*return*/];
    ...
    VolatileModelRepositoryService.prototype.deleteAll = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.models = {};
                return [2 /*return*/];
    ...
    VolatileModelRepositoryService.prototype.loadAll = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/];
            });
...
/* harmony import */ var _analytics_item__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./analytics-item */ "./src/app/models/analytics-item.ts");
/* harmony import */ var _counter_repository_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./counter-repository.service */ "./src/app/models/counter-repository.service.ts");
/* harmony import */ var _counter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./counter */ "./src/app/models/counter.ts");
...
function initializeModelServices(appStateRepositoryService, analyticsItemRepositoryService, counterRepositoryService, countEventRepositoryService) {
    var _this = this;
    return function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
            switch (_a.label) {
...
var ModelModule = /** @class */ (function () {
    ...
    ModelModule_1 = ModelModule;
    ModelModule.forRoot = function () {
        return {
            ...
            providers: [
                ...
                _counter_repository_service__WEBPACK_IMPORTED_MODULE_7__["CounterRepositoryService"],
...
var NotImplementedModalPage = /** @class */ (function () {
    function NotImplementedModalPage(modalController, iab, appStateService) {
        this.modalController = modalController;
        this.iab = iab;
        this.appStateService = appStateService;
    }
    NotImplementedModalPage_1 = NotImplementedModalPage;
    NotImplementedModalPage.prototype.dismissModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    NotImplementedModalPage.prototype.openIssueOnGithub = function () {
        this.iab.create(NotImplementedModalPage_1.GITHUB_URL + "/" + NotImplementedModalPage_1.PROJECT_NAME + "/issues/" + this.issueId);
    };
    NotImplementedModalPage.prototype.openIssueOnIssueHunt = function () {
        this.iab.create(NotImplementedModalPage_1.ISSUEHUNT_URL + "/r/" + NotImplementedModalPage_1.PROJECT_NAME + "/issues/" + this.issueId);
    };
    NotImplementedModalPage.prototype.disableNotImplemented = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.appStateService.setDisableNotImplemented(true)];
                    case 1:
                        _a.sent();
                        this.modalController.dismiss();
                        return [2 /*return*/];
    ...
    NotImplementedModalPage.ctorParameters = function () { return [
...
var NotImplementedComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](NotImplementedComponent, _super);
...
}(_not_implemented__WEBPACK_IMPORTED_MODULE_2__["NotImplemented"]));
...
var NotImplementedDirective = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](NotImplementedDirective, _super);
    function NotImplementedDirective() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
...
var NotImplementedModule = /** @class */ (function () {
    ...
    NotImplementedModule_1 = NotImplementedModule;
    NotImplementedModule.forRoot = function () {
        return {
...
var NotImplemented = /** @class */ (function () {
    ...
    NotImplemented.prototype.ngOnInit = function () {
        var _this = this;
        this.renderer.listen(this.elementRef.nativeElement, this.on, function (e) {
            if (!_this.appState.disableNotImplemented) {
                _this.presentModal();
            }
        });
    };
    NotImplemented.prototype.ngDoCheck = function () {
    ...
    NotImplemented.prototype.presentModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    NotImplemented.ctorParameters = function () { return [
...
var AppStateService = /** @class */ (function () {
    ...
    Object.defineProperty(AppStateService.prototype, "appState", {
        get: function () {
    ...
    AppStateService.prototype.setVibrate = function (v) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var appState;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        appState.vibrate = v;
                        return [4 /*yield*/, this.appStateRepositoryService.save(appState)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    AppStateService.prototype.setRecordPosition = function (v) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var appState, e_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5: return [4 /*yield*/, this.appStateRepositoryService.save(appState)];
                    case 6:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    AppStateService.prototype.setDisableNotImplemented = function (v) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var appState;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    AppStateService.prototype.setUpdateChannel = function (v) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var appState;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.deploy.configure({
    ...
    AppStateService.prototype.update = function (updateMethod) {
        if (updateMethod === void 0) { updateMethod = 'background'; }
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var appState;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        appState = this.appStateRepositoryService.state;
                        return [4 /*yield*/, this.setUpdateChannel(appState.updateChannel)];
                    case 1:
                        _a.sent();
                        if (!(appState.updateChannel !== _models_app_state__WEBPACK_IMPORTED_MODULE_4__["UpdateChannel"].Disabled)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.deploy.sync({
...
var CounterAnalyticsService = /** @class */ (function () {
    function CounterAnalyticsService(countEventRepository) {
        this.countEventRepository = countEventRepository;
    }
    CounterAnalyticsService.prototype.extractHistogramData = function (counter, dateAggregationFunction, countEventFilterCallback, minBuckets, undefinedValue) {
        if (countEventFilterCallback === void 0) { countEventFilterCallback = function () { return true; }; }
        if (minBuckets === void 0) { minBuckets = 0; }
        if (undefinedValue === void 0) { undefinedValue = 0; }
        var countEvents = this.countEventRepository.getByCounter(counter);
        var data = [];
        for (var i = 0; i < minBuckets; ++i) {
            data.push(undefined);
        }
        for (var _i = 0, countEvents_1 = countEvents; _i < countEvents_1.length; _i++) {
            var countEvent = countEvents_1[_i];
    ...
    CounterAnalyticsService.prototype.extractTotalData = function (counter, countEventFilterCallback) {
        if (countEventFilterCallback === void 0) { countEventFilterCallback = function () { return true; }; }
        var countEvents = this.countEventRepository.getByCounter(counter);
        var data = {
            totals: {
        ...
        for (var _i = 0, countEvents_2 = countEvents; _i < countEvents_2.length; _i++) {
            var countEvent = countEvents_2[_i];
            if (!countEventFilterCallback(countEvent)) {
                continue;
            }
            // aggregate counts
    ...
    CounterAnalyticsService.ctorParameters = function () { return [
...
var PositionService = /** @class */ (function () {
    ...
    PositionService.prototype.getPosition = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var position;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        position = null;
                        if (!this.appStateRepositoryService.state.recordPosition) return [3 /*break*/, 2];
...
module.exports = __webpack_require__(/*! /home/runner/work/count/count/src/main.ts */"./src/main.ts");
